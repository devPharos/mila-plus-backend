    ...
    super.init(
      {
        ...
        previous_school_address: Sequelize.STRING,
        ...
        attendance_date_from: Sequelize.STRING,
        attendance_date_to: Sequelize.STRING,
        has_student_maintained_full_time_studies: Sequelize.BOOLEAN,
        is_student_eligible_to_transfer: Sequelize.BOOLEAN,
        transfer_release_date: Sequelize.STRING,
