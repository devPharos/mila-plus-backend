...
class PartnersAndInfluencersController {
    ...
    async index(req, res, next) {
        try {
            ...
            const { count, rows } =
                await PartnersAndInfluencers.findAndCountAll({
                    include: [
                        {
                            model: Filial,
                            as: 'filial',
    ...
    async show(req, res, next) {
        try {
            ...
            const agent = await PartnersAndInfluencers.findByPk(
                partners_and_influencers_id,
                {
    ...
    async update(req, res, next) {
        try {
            ...
            const partnersAndInfluencersExists =
