...
import { verifyAndCreateTextToPayTransaction } from '../../controllers/EmergepayController.js'
                                      ...
                                      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 6px; overflow: hidden; border: 1px solid #e0e0e0;">
                                          ...
                                          <tr>
                                              <td style="padding: 20px 0;">
                                                  ...
                                                  <p style="margin: 20px 40px;">This is a reminder that the payment for the invoice was due on ${format(
                                                      parseISO(
                                                  ...
                                                  <p style="margin: 20px 40px;">If the payment has not been made, we kindly request that you prioritize this matter promptly to prevent any late fees in accordance with our late fee policy.</p>
