...
export async function BeforeDueDateMail({
    receivable_id = null,
    manual = false,
}) {
    try {
        ...
        await mailer.sendMail({
            ...
            bcc:
                process.env.NODE_ENV === 'production'
                    ...
                    : '',
            subject: `MILA Plus - Tuition Fee ${manual ? ' - Resend' : ''} - ${
                                      ...
                                      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 6px; overflow: hidden; border: 1px solid #e0e0e0;">
                                          ...
                                          <tr>
                                              <td style="padding: 20px 0;">
                                                  ...
                                                  <p style="margin: 20px 40px;">This is a friendly reminder that the payment for the invoice is due on ${format(
                                                      parseISO(
        ...
        MailLog({
            ...
            functionName: 'BeforeDueDateMail',
            req: null,
            err,
        })
        return false
